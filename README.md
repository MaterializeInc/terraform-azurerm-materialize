...
>
> While migration is not completely automated, we do have [examples and scripts](https://github.com/MaterializeInc/materialize-terraform-self-managed/tree/main/azure/examples/migration) to help with the transition.
