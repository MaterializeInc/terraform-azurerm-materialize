...
| <a name="input_network_config"></a> [network\_config](#input\_network\_config) | Network configuration for the AKS cluster | <pre>object({<br/>    vnet_address_space = string<br/>    subnet_cidr        = string<br/>  })</pre> | <pre>{<br/>  "subnet_cidr": "10.0.0.0/20",<br/>  "vnet_address_space": "10.0.0.0/16"<br/>}</pre> | no |
